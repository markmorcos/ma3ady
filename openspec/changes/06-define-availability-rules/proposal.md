...
- **NOTE**: depends on changes 05 (tenants) and 07 (services + appointments). This change creates rules + exceptions schema; the function body is finalized when 07 lands. Both can be in same migration if change 07 is implemented immediately after.
