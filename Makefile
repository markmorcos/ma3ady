.PHONY: help install dev-up dev-down migrate-new migrate-up seed expo-start expo-start-dev-client build-dev-ios build-dev-android build-preview build-prod lint typecheck test test-coverage
